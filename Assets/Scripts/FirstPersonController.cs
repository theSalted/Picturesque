...
namespace PlayerInputSystem
{
    ...
    public class FirstPersonController : MonoBehaviour
    {
        ...
        public bool canMove = true; // Variable to control movement and rotation
        ...
        // Methods to control movement and rotation updates
        public void SuspendMovementAndRotation()
        {
            canMove = false;
        }

        public void ResumeMovementAndRotation()
        {
            canMove = true;
        }
    }
